...
struct SkewedUniformDistributionBuilder : public DistributionBuilder {
    ...
    SkewedUniformDistributionBuilder& set_hot_dist_builder(
        DistributionBuilderPtr hot_dist_builder) {
        hotDistBuilder = std::move(hot_dist_builder);
        return *this;
    }

    SkewedUniformDistributionBuilder& set_cold_dist_builder(
        DistributionBuilderPtr cold_dist_builder) {
        coldDistBuilder = std::move(cold_dist_builder);
        return *this;
    }
