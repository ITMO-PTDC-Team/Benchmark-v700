...
public:
    SkewedUniformDistribution(Random64& _rng, Distribution* _hotDistribution,
                              Distribution* _coldDistribution, const double _hotProb,
                              const size_t _hotSetLength)
        : hotDistribution(_hotDistribution),
          coldDistribution(_coldDistribution),
          rng(_rng),
          hotProb(_hotProb),
          hotSetLength(_hotSetLength) {
    }
